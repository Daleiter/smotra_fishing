...
def podcepit():
    ...
    #pyautogui.click(699, 597) # hleb
    pyautogui.click(1113, 597) # motyl
...
def slovlia():
    ...
    while True:
        if 225 <= pimana_pixel_kartinka[1] <= 240:
            ...
            print('capcha', pimana_pixel_kartinka, popytka,pimana_pixel_srazu)
            return 'capcha'
        elif 200 <= pimana_pixel_srazu[1] <= 205:
            print('srazu',pimana_pixel_srazu, popytka, pimana_pixel_kartinka)
            return 'gotovo'
        elif 210 <= pimana_pixel_srazu[0] <= 225:
            print('huevo',pimana_pixel_srazu, popytka)
            return 'huevo'
